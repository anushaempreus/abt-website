...
const services = [
  { num: '01', tag: 'Repairs', title: 'Smash Repairs', img: '/images/photo-1625047509248-ec889cbff17f.jpg', desc: 'State of the art technology and equipment. Premium quality products and skilled technicians. Pre and post repair checklists completed on all vehicles.', contact: null, cta: { label: 'Read More', href: '/about' }, size: 'large' },
  { num: '02', tag: 'Painting', title: 'Vehicle Spray Painting', img: '/images/photo-1558618666-fcd25c85cd64.jpg', desc: 'Highest standards of vehicle painting using the industry leading Sikkens Refinishing System. Only highly skilled paint technicians employed.', contact: null, cta: null, size: 'small' },
  { num: '03', tag: 'Quoting', title: 'Quoting & Assessing', img: '/images/photo-1450101499163-c8848c66ca85.jpg', desc: 'Digital images taken in under 15 minutes. 90% of vehicles completed on time. We keep you informed throughout the entire repair process.', contact: null, cta: { label: 'Book Online', href: '/quote' }, size: 'small' },
  { num: '04', tag: 'Fleet', title: 'Fleet Company Repairs', img: '/images/photo-1486006920555-c77dcf18193c.jpg', desc: 'Extensive experience with Fleet Management Companies. Primary repairer for Innovation, a major fleet company, for over 10 years.', contact: null, cta: { label: 'Contact Us', href: '/contact' }, size: 'large' },
  { num: '05', tag: 'Dents', title: 'Paintless Dent Removal', img: '/images/photo-1600880292089-90a7e086ee0c.jpg', desc: 'Repairs hail and light impact dents without repainting. Cost-effective solution that removes damage without the necessity of repainting.', contact: 'No More Dents. Phone: 0403 906 258', cta: null, size: 'small' },
  { num: '06', tag: 'Towing', title: 'Towing Vehicles', img: '/images/photo-1606577924006-27d39b132ae2.jpg', desc: 'Preferred towing sub-contractor Discount Towing Canberra available 24 hours a day, 365 days a year.', contact: 'Discount Towing Canberra. Phone: 0411 259 945', cta: null, size: 'small' },
  { num: '07', tag: 'Glass', title: 'Windscreen Replacement', img: '/images/photo-1503376780353-7e6692767b70.jpg', desc: 'Complete windscreen replacement service via our preferred windscreen repairer. Quick and professional.', contact: 'Auto Windscreen Service. Phone: 0419 214 722', cta: null, size: 'small' },
  { num: '08', tag: 'Wheels', title: 'Wheel Repairs', img: '/images/photo-1611821064430-0d40291d0f0b.jpg', desc: 'Wheel repair service available via Wicked Wheels for vehicles repaired at our Mitchell workshop.', contact: 'Wicked Wheels. Phone: 0407 051 892', cta: null, size: 'small' },
]
  ...
  return (
    <div style={{ ...M, background: BLACK, color: TEXT }}>
      ...
      <div style={{ position: 'relative', height: '60vh', minHeight: 420, overflow: 'hidden' }}>
        <img src="/images/photo-1615906655593-ad0386982a0f.jpg" alt="Workshop"
